 ...
 * Routes to Foot Locker (Patchright headless:false) or generic (Patchright headless:true) automatically.
 *
 * Both scrapers use Patchright (Playwright fork with anti-bot patches).
...
// =====================================================================
// BROWSER MANAGEMENT (both use patchright)
// =====================================================================

/**
 * Generic browser — headless:true (for non-Foot Locker stores)
 */
...
/**
 * Foot Locker browser — headless:false (bypasses Kasada bot detection)
 */
...
// =====================================================================
// FOOT LOCKER SCRAPER (Patchright headless:false — bypasses Kasada)
// =====================================================================
...
// =====================================================================
// GENERIC SCRAPER (Patchright headless:true — fast, no bot detection)
// =====================================================================
